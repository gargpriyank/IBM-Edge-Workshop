...
[Environment Setup](setup-environment.md). It includes:

- Have an IBM Cloud account with required privileges
- [Install IBM Cloud CLI](setup-environment.md#install-ibm-cloud-cli)
- [Install the IBM Cloud CLI Plugins](setup-environment.md#ibm-cloud-cli-plugins)
  `infrastructure-service`, `schematics` and `container-registry`.
- [Log in to IBM Cloud with the CLI](setup-environment.md#login-to-ibm-cloud)
- [Install Terraform](setup-environment.md#install-terraform)
- [Configure access to IBM Cloud](setup-environment.md#configure-access-to-ibm-cloud) for
  Terraform and the IBM Cloud CLI
- [Install IBM Cloud Terraform Provider](setup-environment.md#configure-access-to-ibm-cloud)
