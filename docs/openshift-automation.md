...
[Environment Setup](https://github.com/gargpriyank/IBM-Edge-Workshop/blob/main/docs/setup-environment.md). It includes:

- Have an IBM Cloud account with required privileges
- [Install IBM Cloud CLI](https://github.com/gargpriyank/IBM-Edge-Workshop/blob/main/docs/setup-environment.md#install-ibm-cloud-cli)
- [Install the IBM Cloud CLI Plugins](https://github.com/gargpriyank/IBM-Edge-Workshop/blob/main/docs/setup-environment.md#ibm-cloud-cli-plugins)
  `infrastructure-service`, `schematics` and `container-registry`.
- [Log in to IBM Cloud with the CLI](https://github.com/gargpriyank/IBM-Edge-Workshop/blob/main/docs/setup-environment.md#login-to-ibm-cloud)
- [Install Terraform](https://github.com/gargpriyank/IBM-Edge-Workshop/blob/main/docs/setup-environment.md#install-terraform)
- [Configure access to IBM Cloud](https://github.com/gargpriyank/IBM-Edge-Workshop/blob/main/docs/setup-environment.md#configure-access-to-ibm-cloud) for
  Terraform and the IBM Cloud CLI
- [Install IBM Cloud Terraform Provider](https://github.com/gargpriyank/IBM-Edge-Workshop/blob/main/docs/setup-environment.md#configure-access-to-ibm-cloud)
...
1. Create `workspace` directory in your local linux/mac box. Download **IBM-Edge-Workshop** project code.

    ```markdown
    mkdir <your_home_dir>/workspace
    cd <your_home_dir>/workspace
    git clone https://github.com/IBM/IBM-Edge-Workshop.git
    cd IBM-Edge-Workshop/iac
    ```
